      ...
      >
        ...
        <div className="text-center mb-8">
          <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} transition={{ duration: 0.3 }}>
            <h1 className="text-4xl font-display font-bold text-slate-900 mb-2">{getPageTitle()}</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
          ...
          <AnimatePresence>
            {serverError && (
              <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="mb-6 p-3 bg-red-50 border border-red-200 rounded-lg">
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 'phone' && (
              <motion.div key="phone" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} transition={{ duration: 0.3 }}>
                ...
                <div className="mb-6">
                  <label className="block text-sm font-medium text-slate-700 mb-2">{t('auth.phoneNumber')}</label>
                  <div className="flex">
                    ...
                    <input
                      ...
                      className={`flex-1 px-4 py-3 border rounded-r-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors ${phoneError ? 'border-red-500 bg-red-50' : 'border-slate-300'}`}
            ...
            {step === 'otp' && (
              <motion.div key="otp" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.3 }}>
                <button type="button" onClick={handleChangeNumber} className="flex items-center gap-2 text-slate-600 hover:text-slate-900 mb-6 transition-colors">
                ...
                <div className="text-center mb-6">
                  <h2 className="text-lg font-semibold text-slate-900 mb-2">{t('auth.enterVerificationCode')}</h2>
                ...
                <Button type="button" variant="primary" size="lg" onClick={handleOtpVerify} disabled={otpCode.length !== 6 || isVerifying} className="w-full mb-6">
            ...
            {step === 'register1' && (
              <motion.div key="register1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.3 }}>
            ...
            {step === 'register2' && (
              <motion.div key="register2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.3 }}>
                <StepIndicator current={2} />

                <button type="button" onClick={handleBackToStep1} className="flex items-center gap-2 text-slate-600 hover:text-slate-900 mb-6 transition-colors">
                  <ArrowLeftIcon className="w-4 h-4" />
